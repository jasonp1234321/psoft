...
public final class RatPolyTest {
    ...
    //  in .add and .negate may have unforeseen consequences elsewhere in the tests,
    ...
    public void testDegreeZero() {
        ...
        assertEquals(0, poly(100, 0).degree(), "100*x^0 degree 0");
    }

    @Test
    public void testDegreeNonZero() {
        assertEquals(-1, poly(0, 100).degree(), "0*x^100 degree -1");
        assertEquals(-1, poly(0, 0).degree(), "0*x^0 degree -1");
